...
audisen_usb.exe : audisen_usb.c ftd2xx.h define.o amp.o ams.o frame.o usb.o ftd2xx.lib
	gcc audisen_usb.c  define.o amp.o ams.o frame.o usb.o ftd2xx.lib -o audisen_usb.exe
